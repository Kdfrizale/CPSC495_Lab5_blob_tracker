...
def findBlob(imageReceived):
    print imageReceived.data

    testvar = raw_input("helllsdfkjlask")
    ...
    hul=0#####Change these to these values to those of the ball being found
    huh=50
    sal=0
    sah=50
    val=0
...
def listener_for_camera():
    ...
    # run simultaneously.
    rospy.init_node('trashthis', anonymous=True)
